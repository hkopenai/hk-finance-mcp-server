...
class TestStampDutyStatisticsTool(unittest.TestCase):
    def setUp(self):
        self.sample_data = [
            {'Period': '202501', 'SD_Listed': '3554.692596', 'SD_Unlisted': '27.088813'},
    ...
    def test_get_stamp_duty_statistics_with_filters(self, mock_urlopen):
        ...
        result = tool_stamp_duty_statistics.get_stamp_duty_statistics(start_period='202501', end_period='202501')
        
        self.assertEqual(len(result), 1)
        self.assertEqual(result[0]['period'], '202501')

        result = tool_stamp_duty_statistics.get_stamp_duty_statistics(start_period='202503')
