...
class TestNegResidentMortgageIntegration(unittest.TestCase):
    ...
    def test_fetch_neg_equity_data_live(self):
        ...
        try:
            ...
            self.assertTrue('outstanding_loans' in result[0], "Expected 'outstanding_loans' key in result")
    ...
    def test_fetch_neg_equity_data_with_filters_live(self):
        ...
        try:
            ...
            result = fetch_neg_equity_data(start_year=2023, start_month=1, end_year=2023, end_month=12)
            self.assertIsInstance(result, list)
