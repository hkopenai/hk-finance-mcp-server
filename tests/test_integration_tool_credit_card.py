...
class TestCreditCardIntegration(unittest.TestCase):
    ...
    def test_fetch_credit_card_data_live(self):
        ...
        try:
            ...
            self.assertTrue('accounts_count' in result[0], "Expected 'accounts_count' key in result")
    ...
    def test_fetch_credit_card_data_with_filters_live(self):
        ...
        try:
            ...
            result = fetch_credit_card_data(start_year=2023, start_month=1, end_year=2023, end_month=12)
            self.assertIsInstance(result, list)
