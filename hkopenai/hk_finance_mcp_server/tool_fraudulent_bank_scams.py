    ...
    return {
        ...
        "items": {
            ...
            "properties": {
                "issue_date": {
                    "type": "string",
                    "description": "Date the scam was reported",
                },
                "alleged_name": {
                    "type": "string",
                    "description": "Name of the bank being impersonated",
                },
                "scam_type": {
                    "type": "string",
                    "description": "Type of scam (e.g., fraudulent website)",
                },
                "pr_url": {
                    "type": "string",
                    "description": "URL to the press release or alert",
                },
                "fraud_website_address": {
                    "type": "string",
                    "description": "Fraudulent website URL (obfuscated)",
                },
            },
            "required": [
                "issue_date",
